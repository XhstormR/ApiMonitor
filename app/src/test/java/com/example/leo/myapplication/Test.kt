...
fun main() {
    ...
    println(s.indexOf(p1))
    println(ByteArraySearcher(p1).indexOf(s))
    println(s.indexOf(p2))
    println(ByteArraySearcher(p2).indexOf(s))
    println(s.indexOf(p3))
    println(ByteArraySearcher(p3).indexOf(s))
    println(s.indexOf(p4))
    println(ByteArraySearcher(p4).indexOf(s))
    println(s.indexOf(p5))
    println(ByteArraySearcher(p5).indexOf(s))
}
